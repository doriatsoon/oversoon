...
$pdf->Ln(0);//Saut de ligne
$pdf->Cell(190,7,'Avec '.$row['acteur'].', '.$row['acteur2'].', '.$row['acteur3'].'',0,1,'L');//Création d'une cellule de texte
$pdf->Ln(0);//Saut de ligne
...
$pdf->Ln(15);//Saut de ligne
$pdf->MultiCell(190,6,"Resume: \n".html_entity_decode($row['resume'],ENT_QUOTES),1,'LR','F',0); //Création d'une cellule de texte
