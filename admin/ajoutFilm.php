...
<embed src="swf/menu.swf?page=videos" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="611" height="30"></embed></object>
            ...
            <div id="centre">
                ...
                <div id="contentVideo">                
                    <form action="action/ajoutFilmAction.php" method="post" name="formulaire" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" id="form_annee" name="annee" class="form"/>
                            </p>
                            <p>
                                <label for="form_real">R&eacute;alisateur:</label>
                                <input type="text" id="form_real" name="real" class="form"/>
                            </p>
                            <p>
                                <label for="form_acteur">Acteur:</label>
                                <input type="text" id="form_acteur" name="acteur" class="form"/>
                            </p>
                            <p>
                                <label for="form_acteur2">Acteur 2:</label>
                                <input type="text" id="form_acteur2" name="acteur2" class="form"/>
                            </p>
                            <p>
                                <label for="form_acteur3">Acteur 3:</label>
                                <input type="text" id="form_acteur3" name="acteur3" class="form"/>
                            </p>
                            <p>
                                <label for="form_genre">Genre:</label>
                                <input type="text" id="form_genre" name="genre" class="form"/>
                            </p>
                            <p>
                                <label for="form_duree">Dur&eacute;e:</label>
                                <input type="text" id="form_duree" name="duree" class="form"/>
                            </p>
                            <p>
                                <label for="form_resume">R&eacute;sum&eacute;:</label>
                                <textarea id="form_resume" name="resume" class="form" cols="50" rows=""></textarea>
                            </p>
                            <p>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align:justify;width:70%;padding-left:15px;padding-right:10px;" colspan="2">
                                <p>Ce module est n&eacute;cessaire pour l'ajout des films dans l'annuaire.</p>
                            </td>
                        </tr>                       
                    </table>
                </div>
