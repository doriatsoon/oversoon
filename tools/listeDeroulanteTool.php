...
function listeDeroulante(){
	...
	//requete pour les listes déroulantes
	...
	if(isset($_SESSION['acteur'])){
		...
		echo '<select name="acteur" style="border:1px solid #2C1E75;color:#2C1E75;background-color:#E8E4F8;"><option>Acteur</option>';
		...
		echo '<select name="categorie" style="border:1px solid #2C1E75;color:#2C1E75;background-color:#E8E4F8;"><option>Categorie</option>';
		...
		echo '<select name="lettre" style="border:1px solid #2C1E75;color:#2C1E75;background-color:#E8E4F8;"><option>Lettre</option>';
		...
		echo '<select name="realisateur" style="border:1px solid #2C1E75;color:#2C1E75;background-color:#E8E4F8;"><option>Realisateur</option>';
        ...
        echo '<select name="annee" style="border:1px solid #2C1E75;color:#2C1E75;background-color:#E8E4F8;"><option>Annee</option>';
