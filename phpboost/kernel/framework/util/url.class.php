...
function html_convert_absolute2root_relative($html_text,$path_to_root=PATH_TO_ROOT,$server_url=SERVER_URL)
{
$path_to_root_bak=Url::path_to_root();
$server_url_bak=Url::server_url();
...
function html_convert_root_relative2relative($html_text,$path_to_root=PATH_TO_ROOT,$server_url=SERVER_URL)
{
$path_to_root_bak=Url::path_to_root();
$server_url_bak=Url::server_url();
...
function _convert_url_to_root_relative($url_params)
{
$url=new Url($url_params[2]);
...
function _build_html_match_regex($only_match_relative=false)
{
